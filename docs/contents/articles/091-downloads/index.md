...
If you have problems installing node.js and/or other tools to build and run PowerAnalyst on your machine and you just want to download html/js/css files, you can find links for download on this page.
...
[PowerAnalyst 1.2.0](/blur-admin/downloads/blur-admin-1.2.0.zip)
